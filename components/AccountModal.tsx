...
export default function AccountModal({ isOpen, onClose }: AccountModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent 
        className="relative w-full max-w-md bg-gradient-to-br from-canvas via-surface to-canvas rounded-2xl shadow-2xl border border-muted-surface/50 overflow-hidden p-0"
        hideCloseButton
      >
